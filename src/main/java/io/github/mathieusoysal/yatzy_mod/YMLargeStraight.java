...
/**
 * The YMLargeStraight class represents the "Large Straight" category in the
 * Yatzy game.
 * In the "Large Straight" category, the player scores 20 if the dice read [2,
 * 3, 4, 5, 6] in ascending order.
...
class YMLargeStraight implements YatzyModInterface {
     ...
     * values.
     * The player scores 20 if the dice read [2, 3, 4, 5, 6] in ascending order.
     *
